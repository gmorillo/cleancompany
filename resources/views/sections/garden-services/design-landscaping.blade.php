@extends('layouts.app')
@section('title')
	<title>Navalimp, Servicios de jardinería, diseño y pisajismo de jardines</title>
@endsection
@section('metas')
	<meta name="description" content="Servicios profesionales de jardinería, realizamos diseños y paisajimos de jardines">
...
@section('content')
	...
	<section class="well2 bg-round bg-round_bot well2__ins1" style="background-color: #40acff; padding-bottom: 150px;">
		<div class="container">
			<h3 class="center">Diseño y Paisajismo<span></span></h3>
