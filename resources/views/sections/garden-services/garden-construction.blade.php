@extends('layouts.app')
@section('title')
	<title>>Navalimp, construcción de jardines</title>
@endsection
@section('metas')
	<meta name="description" content="Servicios de construcción de garajes, parking, parking al aire libre y más.">
...
@section('content')
	<div class="container-fluid p-0">
		<img class="" src="{{ asset('img/construction-garden-header.jpg') }}" alt="">
	</div>
	<section class="well2 bg-round bg-round_bot well2__ins1" style="background-color: #40acff; padding-bottom: 150px;">
		<div class="container">
			<h3 class="center">Construcción de Jardines<span></span></h3>
