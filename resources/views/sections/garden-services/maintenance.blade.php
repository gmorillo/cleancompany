@extends('layouts.app')
@section('title')
	<title>>Navalimp, Mantenimiento de jardines</title>
@endsection
@section('metas')
	<meta name="description" content="Servicio de mantenimiento de jardines, oferta tiempo limitado">
...
@section('content')
	<div class="container-fluid p-0">
		<img class="" src="{{ asset('img/mantenimiento-garden-header.jpg') }}" alt="">
	</div>
	<section class="well2 bg-round bg-round_bot well2__ins1" style="background-color: #40acff; padding-bottom: 150px;">
		<div class="container">
			<h3 class="center">Servicios de Mantenimiento<span></span></h3>
